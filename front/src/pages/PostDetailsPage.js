...
export const PostDetailsPage = () => {
  ...
  const [loadingCreatePostData, loadingCreatedPost, errorCreatedPost, setErrorMessage, errorMessageCreatedPost] = useCreatePosts();
  ...
  errorCreatedPost &&
    toast.error(errorMessageCreatedPost.data[0].message || errorMessageCreatedPost.data, {
      position: "top-center",
      autoClose: 5000,
        ...
        <div className="mb-48">
          ...
          <div className="flex min-h-full flex-col  justify-center  mx-26 px-6 py-12 lg:px-8">
            ...
            <div className="sm:mx-auto sm:w-full sm:max-w-sm flex flex-col gap-3">
                    ...
                    <div class="flex-1 space-y-6 py-1">
                      ...
                      <div className="flex gap-3">
                        ...
                        <div className="flex gap-3 h-6 rounded-full border border-[#E0E0E0] items-center px-2">
                          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 25 25" stroke-width="1.5" stroke="currentColor" className="w-4 h-6 text-[#6F6F6F]">
                            <path
                              stroke-linecap="round"
                              stroke-linejoin="round"
              ...
              <form type="submit" className="flex flex-col gap-2 justify-center mb-8">
                <textarea
                  id="content"
                  name="content"
                    ...
                    .map((comentario) => {
                      return (
                        <ComentarioPost
                          ...
                          impressions={comentario.impressions}
                          toResult={toResult}
                          payload={payload}
                        />
                      );
